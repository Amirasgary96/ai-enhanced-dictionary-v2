...
import backgroundImage from '../assets/hospital-background.jpg'; // You'll need to add this image to your project

function Header({ darkMode, setDarkMode }) {
  return (
    <header className={`relative ${darkMode ? 'bg-gray-800' : 'bg-blue-600'} text-white p-4 shadow-lg`}>
      ...
      <div className="relative container mx-auto flex justify-between items-center z-10">
        <h1 className="text-3xl font-bold text-white">AI-enhanced Dictionary</h1>
        <button
